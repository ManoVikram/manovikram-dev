...
const Hero = () => {
    return (
        <section className="min-h-dvh flex flex-col justify-center items-start py-6 md:py-8 gap-18">
            ...
            <a href='#contact' className='group flex justify-between items-center bg-primary hover:bg-background border-[1] hover:border-[1] border-transparent hover:border-primary px-6 py-4 rounded-full gap-3 transition-colors duration-300 cursor-pointer'>
